...
def get_all_users():
    """gets a list of users from the database, sorted by username
    
    Args: none
    
    Returns: an array(list) of all users from the Users table in the db sorted alphabetically by username"""
...
def get_single_user(id):
    ...
    Returns single user dictionary"""
